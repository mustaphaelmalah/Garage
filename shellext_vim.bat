...
set VIM=%ProgramFiles(x86)%\Vim\vim80\vim.exe
...
rem reg add "HKEY_CLASSES_ROOT\Unknown\shell" /f /ve /d "vim"
rem reg add "HKEY_CLASSES_ROOT\Unknown\shell\vim\command" /f /ve /d "\"%VIM%\" \"%%1\""


assoc .="No Extension"
ftype "No Extension"="%VIM%" "%%1"
